<aside class="right-side">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tải ảnh qrcode</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Tải về hình ảnh qrcode</h3><br>
                    </div><!-- /.box-header -->
                    <!-- form start -->
					<div class="col-md-12">
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data" action="">
                        <div class="box-body">
							...
							<div class="form-group row-fluid">
                                <label class="col-md-3">Folder tải về:</label>
                                <div class="col-md-9">
									<input type="text" class="form-control" name="location_download" required="" placeholder="C:/Downloads/qrcode/"/>
								</div>
                            </div>
                        </div>
