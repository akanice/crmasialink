					...
					<div class="box box-success box-solid">
						...
						<div class="box-body">
                            <div class="form-group row-fluid">
                                ...
                                <div class="col-md-10"><input type="text" class="form-control" name="name" value="<?=$products->name?>" required=""/></div>
                            </div>
                            <div class="form-group row-fluid">
                                <label class="col-md-2">Mã linh kiện (SKU)</label>
                                <div class="col-md-10"><input type="text" class="form-control" name="sku" value="<?=$products->sku?>" /></div>
                            </div>
							<div class="form-group row-fluid">
								<label class="col-md-2">Tuổi thọ</label>
								<div class="col-md-2">
									<input type="number" class="form-control" name="longevity" required="" value="<?=$products->longevity?>"/>
								</div>
								<div class="col-md-2">
							...
							<div class="form-group row-fluid">
								...
								<div class="col-md-10"><textarea class="ckeditor form-control" name="note"><?=$products->note?></textarea></div>
							</div>
                            <!-- /.box-body -->
                        </div>
					...
					<div class="box box-success box-solid">
						...
						<div class="box-body">
							<div class="form-group row-fluid">
                                ...
                                <div class="col-md-8">
                                    <input type="file" accept="image" class="" name="images"/>
					...
					<div class="box box-primary box-solid">
						...
						<div class="box-body">
							<div class="form-group row-fluid">
								...
								<div class="col-md-10"><input type="text" class="form-control" name="input_price" required="" value="<?=$products->input_price?>"/></div>
							</div>
							<div class="form-group row-fluid">
								<label class="col-md-2">Giá bán</label>
								<div class="col-md-10"><input type="text" class="form-control" name="sell_price" required="" value="<?=$products->sell_price?>"></div>
							</div>
						</div>
						<div class="box-footer">
							<input type="submit" class="btn btn-primary" name="submit" value="Lưu lại">
