...
<nav class="navbar navbar-transparent navbar-absolute">
    <div class="container">    
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><img src="<?=base_url('assets/img/logo_800x1320.png')?>" width="80px"></a>
        </div>
    	...
    	<footer class="footer footer-transparent">
            <div class="container">
                ...
                <p class="copyright pull-right">
                    © 2016 <a href="http://akanice.com">akanice</a> - Made for crm.asialinktravel.com
                </p>
            </div>
        </footer>
