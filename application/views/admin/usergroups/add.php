<aside class="right-side">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Thêm mới nhóm nhân viên</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Thêm mới nhóm nhân viên</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="POST" action="<?=base_url('admin/usergroups/add')?>">
                        <div class="box-body">
                                        ...
                                        <div class="col-xs-3 margin-bottom" style="margin-left: 15px">
                                            ...
                                            foreach ($p as $v => $name){
                                                ...
                                                <div style="padding-left: 20px;">
                                                    <input class="input-p input-c<?=$c?>" id="input-p<?=$i?>" type="checkbox" name="permission[]" value="<?=strtolower($controller)?>,<?=$v?>" onclick="">
