						...
						<div class="box-body box-profile">
							<div class="block-relative text-center">
								...
								<span class="block-absolute" data-toggle="modal" data-target="#edit_avatar_modal">
									<img src="/assets/img/paint-brush.png" class="img-holder">
								</span>
							</div>
							...
							<a href="#" class="btn btn-primary btn-block btn-fill"><b>Xem chi tiết</b></a>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="tab-pane" id="settings">
									<form class="form-horizontal block-relative" method="POST" id="edit_info">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<button type="button" class="btn btn-success btn-fill" id="button_edit_info">Chỉnh sửa</button>
												<button type="button" class="btn btn-primary btn-fill" style="display:none;" id="button_cancel_info">Hủy bỏ</button>
												<button type="submit" class="btn btn-danger btn-fill" style="display:none;" id="button_save">Lưu lại</button>
											</div>
										</div>
									</form>
								</div>
		...
		<div class="modal-content">
			<form action="" method="POST" id="edit_avatar" enctype="multipart/form-data" action="">
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-primary btn-fill btn-wd">Lưu lại</button>
				</div>
			</form>
		</div>
		<!-- /.modal-content -->
