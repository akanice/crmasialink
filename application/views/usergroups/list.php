...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?=site_url('admin/usergroups')?>">Quản lý nhóm người dùng</a></li>
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <?php if($list) foreach ($list as $item){ ?>
                            <tr class="odd gradeX">
                                <td><?=@$item->id?></td>
                                <td><?=@$item->name?></td>
                                <td style="text-align: center"><a href="<?=@base_url('admin/admingroups/edit/'.$item->id)?>"><i class="fa fa-pencil"></i> Sửa</a> | <a href="<?=@base_url('admin/admingroups/delete/'.$item->id)?>" onclick="return confirm('Bạn có muốn xóa không?')"><i class="fa fa-trash"></i> Xóa</a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                    </table>
