						...
						<div class="tour-shortinfo rightcol">
							...
							<div class="inner">
								...
								<div class="btn-order-tour center" id="button_order_tour">
									<a href="<?=base_url('dat-tour/order-tour-'.$tour->id)?>" class="btn btn-readmore">Đặt tour ngay<i class="fa fa-chevron-right"></i></a>
								</div>
							</div>
						</div>
				...
				<div class="col-md-9">
					<div class="tour-body">
						...
						<div class="tour-content">
							<ul class="nav nav-tabs affix-top" id="tab-content-tour">
								<li role="presentation" class="active"><a href="#gioithieu" aria-controls="gioithieu" class="scroll">Giới thiệu</a></li>
								<li role="presentation"><a href="#lichtrinh" aria-controls="lichtrinh" role="tab" class="scroll">Lịch trình</a></li>
								<li role="presentation"><a href="#danhgia" aria-controls="danhgia" role="tab" class="scroll">Đánh giá</a></li>
							</ul>
							<!-- Tab panes -->
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="gioithieu">
									<div class="tab-inner">
										...
										<?=@$tour->full_des?>
										<hr>
										<h4 id="lichtrinh">Lịch trình</h4>
										<?=@$tour->itinerary?>
										<hr>
										<h4 id="danhgia">Đánh giá</h4>
										...
										<hr>
										<?=@$tour->call_feedback?>
										<a href="<?=base_url('dat-tour/order-tour-'.$tour->id)?>" class="btn btn-readmore" style="display:block">Đặt tour ngay<i class="fa fa-chevron-right"></i></a>
									</div>
								</div>
							</div>
						</div>
	...
	<?php if (isset($tour_banner) && ($tour_banner != '')) {?>
	<section class="blocksection promo-banner">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div style="padding: 20px 0"><?=@$tour_banner ?></div>
				</div>
			</div>
		</div>
	</section>
